...
a persistence unit "manytomanyPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "manytomany/pom.xml":
...
artifacts ("manytomany-ejb.jar" and "manytomany-web.war") are already built. You can build
